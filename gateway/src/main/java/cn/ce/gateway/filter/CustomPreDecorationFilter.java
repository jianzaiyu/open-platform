 ...
 */
public class CustomPreDecorationFilter extends ZuulFilter {

	private static final Log log = LogFactory.getLog(CustomPreDecorationFilter.class);
	...
	public CustomPreDecorationFilter(RouteLocator routeLocator, String dispatcherServletPath, ZuulProperties properties,
